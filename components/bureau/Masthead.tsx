export function Masthead({
  ...
  return (
    <div className="flex items-end justify-between border-b-[3px] border-double border-ink pb-[14px] max-sm:flex-col max-sm:items-start max-sm:gap-[10px]">
      <div>
        <div className="bureau-eyebrow mb-[6px]">
          Edition · Sunday, April 19, 2026 · N.Y.
        </div>
        <h1 className="bureau-serif text-[clamp(26px,6.5vw,44px)] font-medium leading-none tracking-[-0.03em] max-sm:text-[30px] max-sm:break-words">
          The Prediction Record
        </h1>
      </div>
      <div className="font-mono text-[10px] uppercase leading-[1.7] tracking-[0.1em] text-ink-3 text-right max-sm:text-left">
